...
require('lazy').setup({
  ...
  -- Use the `dependencies` key to specify the dependencies of a particular plugin
  {
    ...
    opts = {
      auto_suggestions_provider = 'openrouterllama',
      -- add any opts here
      -- for example
      provider = 'openrouter',
      vendors = {
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provided by blink.cmp
      {
        ...
        opts = {
          sources = { -- Add 'avante' to the list
    ...
    config = function()
      ...
      -- Setup sourcekit separately since it's not managed by Mason
  ...
  { 'windwp/nvim-ts-autotag', event = { 'InsertEnter', 'BufReadPre', 'BufNewFile' }, opts = {} },
